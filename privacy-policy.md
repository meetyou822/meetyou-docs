...
We use five other companies. We do not sell your data to anyone, and none of
...
| **Brevo** | Your email address | To send account emails — confirming a new sign-up, and password resets |
...
chosen deliberately when the service was set up. Brevo, too, is EU-based
(Paris).
